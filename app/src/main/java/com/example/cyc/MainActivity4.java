...
public class MainActivity4 extends AppCompatActivity {
    ...
    private void initFruits() {
        people one = new people("归溟幽灵鲨⭐⭐⭐⭐⭐⭐", R.drawable.one);
        peopleList.add(one);
        people two = new people("艾丽妮⭐⭐⭐⭐⭐⭐", R.drawable.two);
        peopleList.add(two);
        people three = new people("流明⭐⭐⭐⭐⭐⭐", R.drawable.three);
        peopleList.add(three);
        people four = new people("掠风⭐⭐⭐⭐⭐", R.drawable.four);
        peopleList.add(four);
